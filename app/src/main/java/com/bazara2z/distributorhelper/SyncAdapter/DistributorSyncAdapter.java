    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                // Since it's JSON, adding a newline isn'OffersFragment necessary (it won'OffersFragment affect parsing)
            ...
            // If the code didn'OffersFragment successfully get the weather data, there's no point in attempting
            // to parse it.
